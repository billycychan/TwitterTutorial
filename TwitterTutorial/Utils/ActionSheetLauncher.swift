...
//  TwitterTutorial
//
//  Created by billy.cychan on 29/8/2021.
//
...
class ActionSheetLauncher: NSObject {
    ...
    private lazy var viewModel = ActionSheetViewoModel(user: user)
    ...
    func show() {
        ...
        tableView.frame = CGRect(x: 0, y: window.frame.height, width: window.frame.width, height: tableViewHeight ?? 0)
